                                        ...
                                        <table class="table table-centered datatable1 dt-responsive nowrap " style="border-collapse: collapse; border-spacing: 0; width: 100%;">
                                                ...
                                                <tbody>
                                                    ...
                                                    <tr>
                                                       ...
                                                       <td> <a href="javascript:void(0);" class="text-danger" data-bs-toggle="tooltip" data-bs-placement="top" title="Delete" onclick="deleteemail(<?= $key->id ?>)"><i class="mdi mdi-trash-can font-size-18"></i></a></td>
  ...
  <script type="text/javascript">
       ...
       function deleteemail(id) {
            swal({
                ...
                if (isConfirm) {
                    window.location.href = "{{ url('deleteemail') }}" + '/' + id;
                }
            });
        }
