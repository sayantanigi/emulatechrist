...
<div style="max-width:700px;
		...
		<div style="width: 100%; padding: 20px; box-sizing: border-box; background: #ff0;">
			<div style="width: 660px;background: #ffffffd1;margin: auto;padding: 15px; box-sizing: border-box;">
				<h2 style="text-align: center; font-size: 30px;font-weight: 800;margin-bottom: 0px; color: #0047ab;">Hello Subscribed User</h2>
				<p style="font-size: 20px;line-height: 23px;font-weight: 600;text-align: center;margin-bottom: 30px; margin-top: 10px;">Greetings from EmulateChrist.com</p>
				<div>
					<h3 class="text-center">{{$mailData['msg']}}</h3>
